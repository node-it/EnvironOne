...
class OPT3001Class
{
  public:
	...
	float    readOpticalResult();
	uint16_t readOpticalManufacturerId();
	uint16_t readOpticalDeviceId();
	uint16_t readOpticalConfigReg();
	uint16_t readOpticalLowLimitReg();
	uint16_t readOpticalHighLimitReg();
    boolean  isOpticalConversionReady();
